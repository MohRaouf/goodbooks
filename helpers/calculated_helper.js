...
exports.editBookRate = function(bookRate, NUsers, userOldRate, userNewRate){
 ...
 *  newAvg = 3
*/
exports.deleteRateFromBook = function(bookRate, NUsers, userOldRate){
    console.log(bookRate, NUsers, userOldRate)
    // subAv = (bookRate*NUsers / (5-userOldRate<=1?1:userOldRate-1)) / (NUsers<=1?1:NUsers-1)
...
exports.addRateToBook = function(bookRate, NUsers, userStars){
